$(document).ready(function() {
    ...
    var makeCharacterElem = function (characterObject) {
        if(!(characterObject.image === null)) { //!($.isEmptyObject(character.image.icon_url))
            $('#searchResults').append('<div class="searchResultsItem"><div class="searchResultsImage"><img src="' + characterObject.image.icon_url + '" /></div><div class="searchResultsText"><h1>' + characterObject.name + '</h1><p>' + characterObject.deck + '</p></div></div>');
        }
        else {
            $('#searchResults').append('<div class="searchResultsItem"><div class="searchResultsImage"><img src="Images/question-mark.jpg"/></div><div class="searchResultsText"><h1>' + characterObject.name + '</h1><p>' + characterObject.deck + '</p></div></div>');
        }
    }
});
